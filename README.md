...
5. The sidebar lists eight canned screener tabs — **Bandar Accumulating**, **Bandar Above MA20**, **Bandar Shift Today**, **Accum/Dist Positive**, **1M / 6M / 3M Net Foreign Flow**, **Foreign Buy Streak ≥5** — plus a composite **Watchlist** that unions all eight and scores each symbol by per-rule weight (mirrors `bandar-master.json`; max composite **11.5**).
