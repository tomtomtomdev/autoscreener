...
- `MarketCatalogTests` — declaration order (`.global` first, then `.composite`…`.currency`), all 11 global indices present + chartable, all 14 commodity/currency symbols present, all 11 IDX-IC sectors, USD/IDR is the sole currency
